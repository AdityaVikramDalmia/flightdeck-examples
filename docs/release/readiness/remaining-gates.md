...
1. **Public release authorization and links:** no visibility change, tag or article enabling at that time. Later release must verify exact private remote commits, approved scope, unauthenticated public links and released LICENSE/NOTICE before enabling articles. Follow [the ordered sequence](release-sequence.md). **Done 2026-09-23:** all twelve repositories are public and were cloned anonymously at their released commits; the four portfolio articles are published (series starts at https://adityadalmia.com/blog/agent-tooling-extracting-the-useful-parts/).
