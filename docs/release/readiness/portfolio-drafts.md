...
All four previously live article URLs were withdrawn through the existing private-image/BNC GitOps workflow. Source `3a309a2` uses private image manifest `sha256:256a308115d9fffd20419b5a82040ac6c8837e849693dc8c17b49d1338eb235e`; deployed GitOps revision `71e81f5c6ae4fc041b04a29aba197dc72d6c6526`. Forty-one normal TLS-verifying public-edge checks confirm the four articles return 404 (three URL forms each) and the other sixteen published article routes return 200. Fresh workstation browser navigation still encounters a certificate warning; no bypass occurred. This browser-path gap remains separate from the passing edge HTTP checks.
